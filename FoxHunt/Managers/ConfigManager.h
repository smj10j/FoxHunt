...
#define CONFIG_PLAYER_JUMP_IMPULSE_INITIAL @"PLAYER_JUMP_IMPULSE_INITIAL"
#define CONFIG_PLAYER_JUMP_IMPULSE_STEP @"PLAYER_JUMP_IMPULSE_STEP"
...
#define CONFIG_PLAYER_BOUNDING_BOX_SCALAR @"PLAYER_BOUNDING_BOX_SCALAR"

#define CONFIG_OBSTACLE_BOUNDING_BOX_SCALAR @"OBSTACLE_BOUNDING_BOX_SCALAR"

#define CONFIG_BYSTANDER_BOUNDING_BOX_SCALAR @"BYSTANDER_BOUNDING_BOX_SCALAR"
